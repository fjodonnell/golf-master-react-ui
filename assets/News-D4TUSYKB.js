import{a as h,j as t}from"./index-Qa1mDR5A.js";import{C as l,a as d}from"./CRow-HhFJsiOf.js";import{C as p,a as u}from"./CCardBody-Du7WCXgU.js";import{b as c,C as m,a as g}from"./CCardTitle-DzJf9GHp.js";import{a as f}from"./index.esm-DU8O3Lkz.js";const a="/golf-master-react-ui/",w=[{id:1,title:"Huston Looks to Go Back to Back in 2026",publishedAt:"2025-11-10T09:00:00",imageUrl:`${a}photos/ZachSwinging.jpg`,summary:"Coming off a monumental TDS victory in 2025, the 32 year old Utahn feels that his best golf is still ahead. Find out why in our exclusive interview with the champ.",author:"Tournament du Sol Media Team",content:`
  ...
  `},{id:2,title:"Carpenter Eyes Redemption After La Purisima Nightmare",publishedAt:"2026-02-15T09:00:00",imageUrl:`${a}photos/AlexSwinging.jpg`,summary:"A two-time champion, a haunted putter, and unfinished business — Alex Carpenter enters 2026 determined to reclaim his place at the top of TDS.",author:"Tournament du Sol Media Team",content:`
        ...
        `}],S=()=>{const[n,o]=h.useState(null),r=e=>{o(n===e?null:e)},i=[...w].sort((e,s)=>new Date(s.publishedAt)-new Date(e.publishedAt));return t.jsxs("div",{className:"px-2 py-4",children:[" ",t.jsx("h2",{className:"text-center mb-4 fw-bold",children:"Tournament du Sol News"}),t.jsxs(l,{className:"justify-content-center g-0",children:[" ",i.map(e=>t.jsx(d,{xs:12,md:8,className:"mb-4 px-1",children:t.jsxs(p,{className:"shadow-sm border-0",children:[t.jsx(c,{orientation:"top",src:e.imageUrl,style:{objectFit:"cover",aspectRadio:"16/9",width:"100%"}}),t.jsxs(u,{children:[t.jsx(m,{className:"fw-bold fs-4 mb-2",children:e.title}),t.jsxs("p",{className:"text-muted mb-1",children:["By ",e.author," •"," ",new Date(e.publishedAt).toLocaleDateString()]}),n===e.id?t.jsx("div",{className:"mt-3",style:{lineHeight:"1.6",fontSize:"1rem"},dangerouslySetInnerHTML:{__html:e.content.trim()}}):t.jsx(g,{className:"mt-3",children:e.summary}),t.jsx("div",{className:"text-center mt-3",children:t.jsx(f,{color:"secondary",variant:"outline",onClick:()=>r(e.id),children:n===e.id?"Show Less":"Read More"})})]})]})},e.id))]})]})};export{S as default};
