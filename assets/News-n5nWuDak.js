import{a as h,j as t}from"./index-BPsASDuK.js";import{C as l,a as d}from"./CRow-B_-zPyXM.js";import{C as p,a as u}from"./CCardBody-BwOjJZAA.js";import{b as c,C as m,a as g}from"./CCardTitle-BwZ2s6Kw.js";import{a as f}from"./index.esm-BoviYutb.js";const a="/golf-master-react-ui/",w=[{id:1,title:"Huston Looks to Go Back to Back in 2026",publishedAt:"2025-11-10T09:00:00",imageUrl:`${a}photos/ZachSwinging.jpg`,summary:"Coming off a monumental TDS victory in 2025, the 32 year old Utahn feels that his best golf is still ahead. Find out why in our exclusive interview with the champ.",author:"Tournament du Sol Media Team",content:`
  ...
  `},{id:2,title:"Carpenter Eyes Redemption After La Purisima Nightmare",publishedAt:"2026-02-15T09:00:00",imageUrl:`${a}photos/AlexSwinging.jpg`,summary:"A two-time champion, a haunted putter, and unfinished business — Alex Carpenter enters 2026 determined to reclaim his place at the top of TDS.",author:"Tournament du Sol Media Team",content:`
        ...
        <p>The opening match featured Team Fun (Ghidotti and O’Donnell) versus Team QAnon (Carpenter and Huston) — and it quickly turned into the Alex Carpenter show.</p>
      
        <p>Carpenter delivered a dominant round, firing a 73 and racking up six birdies along the way. TDS points piled up at record speed as he posted 16.5 points and secured an additional 5-point bonus for low score. Despite his partner being largely absent from the scoring column for much of the morning, Carpenter powered Team QAnon to a convincing 4&3 victory.</p>
        ...
        <p>After a quick lunch and a tactical visit to PGA Superstore, the caravan shifted to SilverRock Resort for round two. The afternoon match pitted Team Ailment (Carpenter and O’Donnell) against Team Chill (Huston and Ghidotti).</p>
      
        <p>Early on, the match felt tight. But midway through the front nine, Team Ailment began to separate. Clean approach shots, steady putting, and timely mistakes from their opponents created momentum that never swung back. The match ended decisively on the 14th green in a 5&4 victory.</p>
      
        <p>The battle for low individual score, however, went down to the wire. O’Donnell held a one-shot lead over Carpenter heading into the 17th hole, positioned to steal five critical points. But Carpenter responded with a clutch birdie on 17 and buried a knee-knocker on 18 to secure a one-shot victory — and another five-point bonus.</p>
        ...
        <p>Elsewhere, the day was far less smooth. Ghidotti struggled mightily to find his game and was overheard multiple times declaring, “<em>New goal: let’s just make a par.</em>” He made only one birdie across 36 holes, went 0-2 in team matches, and currently sits in last place.</p>
      
        <p>Huston battled a stubborn snap hook off the tee, leaving his short game to do heavy lifting throughout the day. O’Donnell has looked steady, but an inability to convert key birdie putts — particularly late at SilverRock — cost him a golden opportunity to close the gap.</p>
      
        <p>And then there’s Carpenter.</p>
      
        <p>Through 36 holes, he has built what feels like a nearly insurmountable lead. Vegas has already installed him as a heavy favorite, and the rest of the field may already be fighting for scraps.</p>
      
        <p><strong>Leaderboard After Day One:</strong><br/>
        Carpenter: 30<br/>
        O’Donnell: 9.5<br/>
        Huston: 7<br/>
        Ghidotti: 3.5</p>
        ...
        <p>Team Nomadic Golfers delivered a decisive 5&4 dismantling of Team SAAMOOOKAS, emphatically flipping the competitive tone of the week.</p>
      
        <p>Leading the charge was FJ, whose steady 74 set the standard for the day. Zach Huston and Alex Carpenter each carded matching 77s, applying consistent pressure across the board. Will Ghidotti struggled to find rhythm, posting an 83 in a round that never quite stabilized.</p>
      
        <p>Afterward, Ghidotti didn’t mince words. “<em>I am disgusted with my performance,</em>” he said bluntly — a rare flash of frustration from one of TDS’s most theatrical competitors.</p>
      
        <p>Adding to the Nomadic surge, Huston captured his first Closest to the Pin honors of the tournament, securing an additional full point and injecting new life into his individual campaign.</p>
      
        <p><strong>Updated Point Standings:</strong><br/>
        Alex – 32<br/>
        FJ – 24<br/>
        Zach – 15<br/>
        Will – 4.5</p>
      
        <p>The scorecard wasn’t the only thing taking damage.</p>
      
        <p>On the par-5 10th, Huston uncorked a drive that drifted just far enough offline to introduce itself to a Morningside residence. The strike echoed through stucco and silence alike — the first property casualty of the day.</p>
      
        <p>Not to be outdone, Ghidotti responded on the par-3 16th in far more theatrical fashion. His tee shot caromed between two unsuspecting patio chairs, ricocheted with pinball precision, and ultimately settled on a nearby roof. Witnesses described it as “architecturally aggressive.” It marked the second house struck of the round and ensured the real estate community remained fully engaged in tournament proceedings.</p>
      
        <p>Despite the neighborhood crossfire, Nomadic Golfers never relinquished control.</p>
      
        <p>Wednesday brings a well-timed off day, with whispers of a team excursion to Joshua Tree National Park to reset and recharge. But rest will be brief.</p>
        ...
        <p><strong>Thursday: Moving Day</strong></p>
      
        <p>The morning began at Trilogy at La Quinta, a layout far more forgiving than earlier stops on the rota. Heavy blows were traded between the Nomadic Golfers and the SSAAAMOOOKAS, with momentum swinging throughout the round. It all came down to the 18th green, where Ghidotti narrowly missed a match-winning putt. The result: a hard-fought tie.</p>
      
        <p>Individually, it was a dart-fest. Carpenter and O’Donnell both went low with matching 71s. Huston and Ghidotti kept pace, posting 78 and 79 respectively.</p>
      
        <p>Six minutes down the road awaited a vastly different test: PGA West’s Norman Course, designed by The Shark himself. Narrow fairways. Punishing desert waste areas. Firm, fast greens. It felt more like the Australian Outback than the Coachella Valley.</p>
      
        <p>Team Fun (Ghidotti and O’Donnell) jumped out early against Team QAnon (Carpenter and Huston), and the match remained All Square through 12 holes. Then the QAnoners caught fire — three consecutive 3s flipped the match decisively. A tie on 16 sealed a 3&2 victory for Carpenter and Huston.</p>
      
        <p><strong>Norman Course Scores:</strong><br/>
        Carpenter: 75<br/>
        O’Donnell: 76<br/>
        Huston: 80<br/>
        Ghidotti: 84</p>
      
        <p>With five of six qualifying rounds complete, Carpenter commanded the field with 58 points. O’Donnell sat second at 37.5. Huston lingered at 26, eyeing a Friday charge. Ghidotti faced long odds with 12.</p>
      
        <p><strong>Friday: Last Call at Mountain View</strong></p>
      
        <p>Another 5:10 AM wake-up. Another pre-dawn stop at IW Coffee & Chai Bar. The final qualifying round unfolded at Desert Willow’s Mountain View course — reachable par 5s, generous fairways, and one last opportunity to make a move.</p>
      
        <p>Team Ailment (Carpenter and O’Donnell) wasted no time. A blistering 34 from O’Donnell and 35 from Carpenter built a 4-up lead at the turn over Team Chill. The back nine tightened briefly, but a clutch par from Carpenter on the demanding 14th restored control. A 4&3 victory sealed their bids to the TDS Final.</p>
      
        <p>For Huston and Ghidotti, only miracle paths remained: a hole-in-one or double eagle auto-bid. On the 17th, Ghidotti nearly delivered the moment of the tournament — a 285-yard fade with driver on a reachable par 4 that skipped just past the hole. He converted an 18-footer for eagle, the first of TDS 2026, earning five points and igniting the gallery. But without a historic albatross on 18, the comeback fell short.</p>
      
        <p>The consolation match between the longtime rivals was set.</p>
      
        <p>Up ahead, however, the battle for qualifying supremacy raged to the final green. O’Donnell drained a dramatic downhill birdie putt on 18 for a 71 — exactly what he needed to tie Carpenter for low gross across six rounds. Both finished qualifying at +17.</p>
      
        <p><strong>Final Qualifying Round Scores:</strong><br/>
        O’Donnell: 71<br/>
        Carpenter: 74<br/>
        Ghidotti: 74<br/>
        Huston: 76</p>
      
        <p><strong>Leaderboard After Qualifying:</strong><br/>
        Carpenter: 71.5 pts (+17)<br/>
        O’Donnell: 59 pts (+17)<br/>
        Huston: 27 pts (+47)<br/>
        Ghidotti: 18.5 pts (+56)</p>
        ...
        `},{id:10,title:"Redemption on 18: Ghidotti Flips the Script in Consolation Clash",publishedAt:"2026-02-28T14:00:00",imageUrl:`${a}photos/DesertWillowFirecliff.jpg`,summary:"One year after heartbreak, Will Ghidotti steadied himself down the stretch and closed out Zach Huston 2 up in a rivalry rematch at Firecliff.",author:"Tournament du Sol Media Team",content:`
        ...
        `},{id:12,title:"O’Donnell Outlasts Carpenter in Firecliff Classic, Claims Second TDS Crown",publishedAt:"2026-03-01T14:00:00",imageUrl:`${a}photos/DesertWillowFirecliff2.jpg`,summary:"After a week-long duel for low gross honors, Francis O’Donnell defeated Alex Carpenter 2&1 at Firecliff, capturing his second Tournament du Sol title in a final that unfolded in waves of pressure and precision.",author:"Tournament du Sol Media Team",content:`
        ...
        `},{id:13,title:"Life After TDS: The Field Returns to Reality",publishedAt:"2026-03-07T14:00:00",imageUrl:`${a}photos/Columbus.jpg`,summary:"With Tournament du Sol concluded, competitors return to their day jobs — but the stories, speculation, and lingering drama from the desert continue to ripple through the field.",author:"Tournament du Sol Media Team",content:`
        <p>The fairways are quiet again.</p>
      
        <p>The carts are parked. The group chats have slowed. And the competitors of Tournament du Sol have returned to the one place none of them truly belong: their desk jobs.</p>
      
        <p>But while the players may be home, the stories from the tournament — and the aftershocks that follow it — are still unfolding.</p>
      
        <p><strong>Carpenter’s Airline Scare</strong></p>
      
        <p>Perhaps the most dramatic post-tournament development came before anyone even made it home.</p>
      
        <p>Carpenter’s golf bag was reportedly the victim of a brutal airline mishap somewhere between baggage claim and the cargo hold. Early reports described general trauma to the bag’s structure, though fortunately no injuries to Carpenter himself were reported.</p>
      
        <p>After a brief recovery period, Carpenter has reportedly stashed away the Newports that fueled his tournament run and returned to his more traditional nicotine regimen.</p>
      
        <p>In a sign that he may be the most responsible competitor in the field, sources also confirm he is the only player who has already unpacked and washed every article of clothing from the trip.</p>
      
        <p><strong>O’Donnell Riding the High</strong></p>
      
        <p>Meanwhile, Francis “FJ” O’Donnell is still floating several feet above the ground following his victory.</p>
      
        <p>The win has apparently emboldened the normally cautious competitor, with whispers circulating that O’Donnell may set his sights on a far bigger stage: the 2026 Hickory Hills Club Championship.</p>
      
        <p>But perhaps the biggest story surrounding the champion isn’t the win itself — it’s the equipment.</p>
      
        <p>O’Donnell’s newly acquired $1,000 putter, affectionately nicknamed “Comma,” has already achieved near-mythical status among the TDS field. Some sources claim the club is receiving special treatment at home, reportedly tucked into the bed of his spare bedroom rather than being tossed in the trunk of his car alongside the rest of his set.</p>
      
        <p>And that set, notably, only includes 12 other clubs.</p>
      
        <p>Yes — despite the standard 14-club allowance in golf, O’Donnell is believed to have captured the TDS title without even carrying a full bag, making him the only champion in tournament history to do so.</p>
      
        <p>Whether it was minimalism, strategy, or simple oversight remains unclear, but the result speaks for itself.</p>
      
        <p><strong>Ghidotti Walks Away… For Now</strong></p>
      
        <p>For Will Ghidotti, the post-tournament mood has been more reflective.</p>
      
        <p>Sources close to the player report that upon returning home he has temporarily stepped away from the game, turning his attention instead to paddle sports.</p>
      
        <p>In fact, Ghidotti was overheard telling friends he plans to sell all of his golf clubs — a declaration that veteran TDS observers recognize as a classic symptom of post-tournament frustration. History suggests the equipment may not stay on the market long.</p>
      
        <p><strong>Huston Continues the Nomad Tour</strong></p>
      
        <p>While others have settled back into their routines, Zach Huston has done the opposite.</p>
      
        <p>Since departing the tournament, Huston has reportedly spent more hours on airplanes than in his own bed, continuing to live up to the reputation that earned him the unofficial title of TDS Nomad.</p>
      
        <p>Frequent flyer miles may not help his handicap, but they do reinforce the mystique of one of the tour’s most elusive competitors.</p>
      
        <p><strong>The Itch Returns</strong></p>
      
        <p>For now, the clubs are mostly back in the garage and the scorecards tucked away.</p>
      
        <p>But if history has shown anything, it’s that the calm after Tournament du Sol never lasts long.</p>
      
        <p>The players may be back behind their desks.</p>
      
        <p>But the itch for more golf has already begun. ⛳️</p>
      
        <p>And somewhere, tucked neatly under a blanket in a quiet spare bedroom, “Comma” waits patiently for its next appearance.</p>
        `}],S=()=>{const[o,r]=h.useState(null),i=e=>{r(o===e?null:e)},s=[...w].sort((e,n)=>new Date(n.publishedAt)-new Date(e.publishedAt));return t.jsxs("div",{className:"px-2 py-4",children:[" ",t.jsx("h2",{className:"text-center mb-4 fw-bold",children:"Tournament du Sol News"}),t.jsxs(l,{className:"justify-content-center g-0",children:[" ",s.map(e=>t.jsx(d,{xs:12,md:8,className:"mb-4 px-1",children:t.jsxs(p,{className:"shadow-sm border-0",children:[t.jsx(c,{orientation:"top",src:e.imageUrl,style:{width:"100%",aspectRatio:"16 / 9",objectFit:"cover",objectPosition:"center",minHeight:"200px",display:"block"},onError:n=>{console.error("Path failed on this device:",n.target.src),n.target.style.border="2px solid red"}}),t.jsxs(u,{children:[t.jsx(m,{className:"fw-bold fs-4 mb-2",children:e.title}),t.jsxs("p",{className:"text-muted mb-1",children:["By ",e.author," •"," ",new Date(e.publishedAt).toLocaleDateString()]}),o===e.id?t.jsx("div",{className:"mt-3",style:{lineHeight:"1.6",fontSize:"1rem"},dangerouslySetInnerHTML:{__html:e.content.trim()}}):t.jsx(g,{className:"mt-3",children:e.summary}),t.jsx("div",{className:"text-center mt-3",children:t.jsx(f,{color:"secondary",variant:"outline",onClick:()=>i(e.id),children:o===e.id?"Show Less":"Read More"})})]})]})},e.id))]})]})};export{S as default};
