import{a as h,j as t}from"./index-CWU1svIp.js";import{C as l,a as d}from"./CRow-D55XMRH-.js";import{C as m,a as p}from"./CCardBody-BfiQ5STO.js";import{b as c,C as u,a as g}from"./CCardTitle-BSeitpoI.js";import{a as f}from"./index.esm-DOZuSOck.js";const i="/golf-master-react-ui/",w=[{id:1,title:"Huston Looks to Go Back to Back in 2026",publishedAt:"2025-11-10T09:00:00",imageUrl:`${i}photos/ZachSwinging.jpg`,summary:"Coming off a monumental TDS victory in 2025, the 32 year old Utahn feels that his best golf is still ahead. Find out why in our exclusive interview with the champ.",author:"Tournament du Sol Media Team",content:`
  ...
  `},{id:2,title:"Carpenter Eyes Redemption After La Purisima Nightmare",publishedAt:"2026-02-15T09:00:00",imageUrl:`${i}photos/AlexSwinging.jpg`,summary:"A two-time champion, a haunted putter, and unfinished business — Alex Carpenter enters 2026 determined to reclaim his place at the top of TDS.",author:"Tournament du Sol Media Team",content:`
        ...
        `}],S=()=>{const[a,n]=h.useState(null),o=e=>{n(a===e?null:e)},s=[...w].sort((e,r)=>new Date(r.publishedAt)-new Date(e.publishedAt));return t.jsxs("div",{className:"p-4",children:[t.jsx("h2",{className:"text-center mb-4 fw-bold",children:"Tournament du Sol News"}),t.jsx(l,{className:"justify-content-center",children:s.map(e=>t.jsx(d,{md:8,className:"mb-4",children:t.jsxs(m,{className:"shadow-sm border-0",children:[t.jsx(c,{orientation:"top",src:e.imageUrl,style:{objectFit:"cover",height:"280px"}}),t.jsxs(p,{children:[t.jsx(u,{className:"fw-bold fs-4 mb-2",children:e.title}),t.jsxs("p",{className:"text-muted mb-1",children:["By ",e.author," •"," ",new Date(e.publishedAt).toLocaleDateString()]}),a===e.id?t.jsx("div",{className:"mt-3",style:{lineHeight:"1.6",fontSize:"1rem"},dangerouslySetInnerHTML:{__html:e.content.trim()}}):t.jsx(g,{className:"mt-3",children:e.summary}),t.jsx("div",{className:"text-center mt-3",children:t.jsx(f,{color:"secondary",variant:"outline",onClick:()=>o(e.id),children:a===e.id?"Show Less":"Read More"})})]})]})},e.id))})]})};export{S as default};
