import{a as r,j as t}from"./index-BPub_UdU.js";import{C as l,a as h}from"./CRow-D3av6jLI.js";import{C as d,a as m}from"./CCardBody-DzEYHSWH.js";import{b as u,C as c,a as p}from"./CCardTitle-BtZQYCS3.js";import{a as g}from"./index.esm-BzZeNQOE.js";const f=[{id:1,title:"Huston Looks to Go Back to Back in 2026",publishedAt:"2025-11-10T09:00:00",imageUrl:"src/assets/images/ZachSwinging.jpg",summary:"Coming off a monumental TDS victory in 2025, the 32 year old Utahn feels that his best golf is still ahead. Find out why in our exclusive interview with the champ.",author:"Tournament du Sol Media Team",content:`
  ...
  `}],j=()=>{const[a,s]=r.useState(null),n=e=>{s(a===e?null:e)},o=[...f].sort((e,i)=>new Date(i.publishedAt)-new Date(e.publishedAt));return t.jsxs("div",{className:"p-4",children:[t.jsx("h2",{className:"text-center mb-4 fw-bold",children:"Tournament du Sol News"}),t.jsx(l,{className:"justify-content-center",children:o.map(e=>t.jsx(h,{md:8,className:"mb-4",children:t.jsxs(d,{className:"shadow-sm border-0",children:[t.jsx(u,{orientation:"top",src:e.imageUrl,style:{objectFit:"cover",height:"280px"}}),t.jsxs(m,{children:[t.jsx(c,{className:"fw-bold fs-4 mb-2",children:e.title}),t.jsxs("p",{className:"text-muted mb-1",children:["By ",e.author," •"," ",new Date(e.publishedAt).toLocaleDateString()]}),a===e.id?t.jsx("div",{className:"mt-3",style:{lineHeight:"1.6",fontSize:"1rem"},dangerouslySetInnerHTML:{__html:e.content.trim()}}):t.jsx(p,{className:"mt-3",children:e.summary}),t.jsx("div",{className:"text-center mt-3",children:t.jsx(g,{color:"secondary",variant:"outline",onClick:()=>n(e.id),children:a===e.id?"Show Less":"Read More"})})]})]})},e.id))})]})};export{j as default};
